import 'package:aplicacion_petbia/data/model/message.dart';
...
class ControllerChat extends GetxController {
  final DatabaseReference _messagesRef =
      FirebaseDatabase.instance.reference().child('fluttermessages');

  void guardarMessage(Message message) {
    _messagesRef.push().set(message.toJson());
  }

  void actualizarMessage(Map<String, dynamic> datosmod, String idmessage) {
    _messagesRef.child(idmessage).update(datosmod);
  }

  void deleteMessage(String idmessage) {
    _messagesRef.child(idmessage).remove();
  }

  Query getMessages() => _messagesRef;
}
